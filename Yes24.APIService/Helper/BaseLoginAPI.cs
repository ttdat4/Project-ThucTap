...
namespace Yes24.APIService.Helper
{
    public class BaseLoginAPI
    {
        ...
        public BaseLoginAPI()
        {
            BaseURL = ConfigurationManager.AppSettings["URLLoginAPI"];
        }
        #endregion
            ...
            params TParam[] arrParam) where T : new()
        {
            ...
            headers.Add(new []{ "UserName", ConfigurationManager.AppSettings["UserNameLoginAPI"] });
            headers.Add(new []{ "Password", ConfigurationManager.AppSettings["PasswordLoginAPI"] });
